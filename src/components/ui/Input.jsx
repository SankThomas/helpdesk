...
export const Input = forwardRef(function Input(
  ...
  return (
    <div className="space-y-1">
      ...
      <input
        ref={ref}
        className={`border-surface-300 text-surface-900 placeholder:text-surface-400 focus:border-primary-500 focus:ring-primary-500 disabled:bg-surface-50 disabled:text-surface-500 block w-full rounded-lg border bg-white px-3 py-2 transition-all duration-200 focus:ring-1 focus:outline-none disabled:cursor-not-allowed ${
          error
